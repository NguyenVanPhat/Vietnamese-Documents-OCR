...
if __name__ == "__main__":
    ...
    save_results = []
    stream = tqdm(image_file_list, total=len(image_file_list))
    for image_file in stream:
        ...
        output_txt_path = os.path.join(args.det_out_txt_dir, img_name_pure.replace('.jpg', '.txt'))
        src_im = utility.draw_text_det_res(dt_boxes, image_file, save_path=output_txt_path)
        if args.visualize:
            img_path = os.path.join(args.det_out_visualize_dir,
